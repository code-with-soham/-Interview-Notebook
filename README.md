...
[![Stars](https://img.shields.io/github/stars/sohamkundu/interview-notebook?style=for-the-badge&color=yellow)](https://github.com/sohamkundu)
[![Forks](https://img.shields.io/github/forks/sohamkundu/interview-notebook?style=for-the-badge&color=orange)](https://github.com/sohamkundu)
[![License](https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge)](https://opensource.org/licenses/MIT)
[![MERN](https://img.shields.io/badge/Stack-MERN-success?style=for-the-badge&logo=mongodb)](https://github.com/sohamkundu)
[![AI](https://img.shields.io/badge/Integrated-AI-9cf?style=for-the-badge&logo=openai)](https://github.com/sohamkundu)

</div>

<div align="center">
  <img src="https://media.giphy.com/media/qgQUggCGvnPt9CBG2m/giphy.gif" alt="Coding GIF" width="400"/>
</div>
...
```mermaid
graph LR
    Start([🚀 Start]) --> JS[JavaScript]
    JS --> React[React]
    React --> Node[Node.js]
    Node --> DB[(MongoDB / SQL)]
    DB --> AI[AI / RAG]
    AI --> Proj[Projects]
    Proj --> Prep[Interview Prep]
    Prep --> Offer{🎉 Offer Letter}
    
    style Start fill:#2ecc71,stroke:#333,stroke-width:2px
    style Offer fill:#f1c40f,stroke:#333,stroke-width:2px
```
...
graph TD
    ...
    Machine[⚙️ Machine Coding Round]
    Proj[🚀 Project Discussion]
    HR[🤝 HR / Behavioral]
    Offer{🎉 Offer Letter}
    ...
    style Offer fill:#2ecc71,stroke:#333,stroke-width:2px
```
